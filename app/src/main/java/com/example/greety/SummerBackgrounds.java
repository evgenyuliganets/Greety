...
public class SummerBackgrounds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summer_backgrounds);
        imageButton12 = findViewById(R.id.imageButton17);
        imageButton13 = findViewById(R.id.imageButton18);
        imageButton14 = findViewById(R.id.imageButton19);
        imageButton15 = findViewById(R.id.imageButton20);
        imageButton16 = findViewById(R.id.imageButton21);
        ...
        imageButton12.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/summer1");
        ...
        imageButton13.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/summer2");
                dsPhotoEditorIntent.setData(uri);
                startActivityForResult(dsPhotoEditorIntent, 200);
        ...
        imageButton14.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/summer3");
                dsPhotoEditorIntent.setData(uri);
                startActivityForResult(dsPhotoEditorIntent, 200);
        ...
        imageButton15.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/summer4");
                dsPhotoEditorIntent.setData(uri);
                startActivityForResult(dsPhotoEditorIntent, 200);
        ...
        imageButton16.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/summer5");
                dsPhotoEditorIntent.setData(uri);
                startActivityForResult(dsPhotoEditorIntent, 200);

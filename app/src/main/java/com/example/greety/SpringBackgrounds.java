...
public class SpringBackgrounds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spring_backgrounds);
        ...
        imageButton12.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/spring1");
        ...
        imageButton13.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/spring2");
                dsPhotoEditorIntent.setData(uri);
                startActivityForResult(dsPhotoEditorIntent, 200);
        ...
        imageButton14.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/spring3");
                dsPhotoEditorIntent.setData(uri);
                startActivityForResult(dsPhotoEditorIntent, 200);
        ...
        imageButton15.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/spring4");
                dsPhotoEditorIntent.setData(uri);
                startActivityForResult(dsPhotoEditorIntent, 200);
        ...
        imageButton16.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://com.example.greety/drawable/spring5");
                dsPhotoEditorIntent.setData(uri);
                startActivityForResult(dsPhotoEditorIntent, 200);
